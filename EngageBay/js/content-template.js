...
const engageBayTemplate = {
	...
	'inline-attachment': 'https://one.ebext.in/repofilepreview?repo_id={{repo_id}}&nid={{getAuthDetails "domain_id"}}&user_id={{getAuthDetails "id"}}&random_id={{random_id}}&thread_id={{thread_id}}&from_email={{from_email}}&source=web_ext',
	...
	"track-content": '<div id="engagebay-track" class="engagebay-track-content engagebay-track-img"><img src="https://one.ebext.in/openmail?nid={{getAuthDetails "domain_id"}}&user_id={{getAuthDetails "id"}}&random_id={{random_id}}&thread_id={{thread_id}}&from_email={{from_email}}&source=web_ext" nosend="1" align="left" width="0" height="0" style="border:0;width:0px;height:0px;opacity:0;" alt=""></img></div>',

	"track-content-outlook": '<img class="engagebay-track-image" src="https://one.ebext.in/openmail?nid={{getAuthDetails "domain_id"}}&user_id={{getAuthDetails "id"}}&random_id={{random_id}}&thread_id={{thread_id}}&from_email={{from_email}}&source=web_ext" nosend="1" align="left" width="0" height="0" style="border:0;width:0px;height:0px;opacity:0;" alt=""></img>',

	"link-open": 'https://one.ebext.in/openurl?nid={{getAuthDetails "domain_id"}}&user_id={{getAuthDetails "id"}}&random_id={{random_id}}&thread_id={{thread_id}}&from_email={{from_email}}&source=web_ext&url={{encodeURL url}}',
	...
	"engagebay-footer": '<div class="engagebay-footer" style="margin-top: 40px;display: block;"><div style="font-size: 11px;color: #868686;"><img src="https://d2p078bqz5urf7.cloudfront.net/cloud/assets/img/green-check.png" style="height: 13px;width: 12px;"> Sent using <a href="https://one.ebext.in/website" target="_blank" style="text-decoration:none;font-size: 11px;">EngageBay</a></div></div>',
